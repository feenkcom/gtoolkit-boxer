...
#[no_mangle]
pub fn boxer_size_i32_get_x(_ptr: *mut BoxerSizeI32) -> i32 {
    BoxerSizeI32::boxer_size_get_width(_ptr)
}

#[no_mangle]
pub fn boxer_size_i32_set_x(_ptr: *mut BoxerSizeI32, width: i32) {
    BoxerSizeI32::boxer_size_set_width(_ptr, width);
}

#[no_mangle]
pub fn boxer_size_i32_get_y(_ptr: *mut BoxerSizeI32) -> i32 {
    BoxerSizeI32::boxer_size_get_height(_ptr)
}

#[no_mangle]
pub fn boxer_size_i32_set_y(_ptr: *mut BoxerSizeI32, height: i32) {
